...
How do I export PDFs or print [4D View Pro](https://us.4d.com/4d-view-pro) documents? (4D v18)

Find more information on the [blog post](https://blog.4d.com/4d-view-pro-manage-printing-and-pdf-export/).
